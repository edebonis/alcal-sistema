# Generated by Django 2.2.3 on 2020-01-06 20:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(blank=True, choices=[('DNI', 'DNI'), ('CI', 'CI'), ('Otro', 'Otro')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_de_registro', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legajo', models.IntegerField(auto_created=True, blank=True, primary_key=True, serialize=False)),
                ('activx', models.NullBooleanField(default=True)),
                ('orden', models.IntegerField(blank=True, null=True)),
                ('libro', models.CharField(blank=True, max_length=5, null=True)),
                ('folio', models.IntegerField(blank=True, null=True)),
                ('anio_ingreso', models.IntegerField(blank=True, default=2020, null=True)),
                ('grupo_tec', models.IntegerField(blank=True, null=True)),
                ('ficha_de_inscripcion', models.NullBooleanField()),
                ('foto_dni_estudiante', models.NullBooleanField()),
                ('foto_dni_estudiante_archivo', models.FileField(blank=True, null=True, upload_to='')),
                ('foto_dni_responsable', models.NullBooleanField()),
                ('partida_de_nacimiento', models.NullBooleanField()),
                ('vacunas', models.NullBooleanField()),
                ('certificado', models.NullBooleanField()),
                ('url_foto', models.URLField(blank=True, null=True)),
                ('archivo_de_seguimiento', models.URLField(blank=True, null=True)),
                ('vinculo', models.CharField(blank=True, choices=[('Abuelo', 'Abuelo'), ('Abuela', 'Abuela'), ('Tutor', 'Tutor'), ('Hermana', 'Hermana'), ('Hermano', 'Hermano'), ('Padre', 'Padre'), ('Madre', 'Madre'), ('Otro', 'Otro')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nota', models.CharField(max_length=10, null=True)),
                ('mesa', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='alcal.MesaPendiente')),
                ('pendiente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='alcal.Pendiente')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mesa', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='alcal.MesaPendiente')),
                ('pendiente', smart_selects.db_fields.ChainedManyToManyField(chained_field='mesa', chained_model_field='pendiente', to='alcal.Pendiente')),
            ],
        ),
        migrations.CreateModel(
            name='Seguimiento',
        ...
        migrations.AddField(
            model_name='mesapendiente',
            name='docente',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='alcal.Docente'),
        ),
        migrations.AddField(
            model_name='materia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maniana', models.CharField(choices=[('t', 'Llegada tarde'), ('T', 'Llegada tarde fuera de hora'), ('A', 'Ausente'), ('r', 'Retirado dentro de la última hora'), ('R', 'Retirado'), ('-', 'Sin Clase'), ('P', 'Presente')], max_length=20)),
                ('tarde', models.CharField(choices=[('t', 'Llegada tarde'), ('T', 'Llegada tarde fuera de hora'), ('A', 'Ausente'), ('r', 'Retirado dentro de la última hora'), ('R', 'Retirado'), ('-', 'Sin Clase'), ('P', 'Presente')], max_length=20)),
                ('ed_fisica', models.CharField(choices=[('t', 'Llegada tarde'), ('T', 'Llegada tarde fuera de hora'), ('A', 'Ausente'), ('r', 'Retirado dentro de la última hora'), ('R', 'Retirado'), ('-', 'Sin Clase'), ('P', 'Presente')], max_length=20)),
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='alcal.Curso')),
                ('estudiante', smart_selects.db_fields.ChainedForeignKey(chained_field='curso', chained_model_field='curso', on_delete=django.db.models.deletion.CASCADE, to='alcal.Estudiante')),
            ],
        ),
